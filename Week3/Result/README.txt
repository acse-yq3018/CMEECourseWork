...
.
├── Code
│   ├── apply1.R                clarify the apply function
│   ├── apply2.R                clarify the apply function
│   ├── basic_io.R              read and write csv in R
│   ├── boilerplate.R           it is just a boilerplate to print something
│   ├── break.R                 clarify the break function in R
│   ├── browse.R                clarify the browse function
│   ├── CompileLaTeX.sh         create a pdf in LaTeX and clean the meaningless files produced
